...
/* Calls the FMI get functions with zero length arrays and logs any problems and
...
/* Calls the FMI set functions with zero length arrays and logs any problems and
   returns either fmi ok/warning status when successful and other fmi status otherwise */
